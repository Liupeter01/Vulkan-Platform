...
MyEngineSwapChain::MyEngineSwapChain(MyEngineDevice &deviceRef,
                                     VkExtent2D extent)
...
MyEngineSwapChain::MyEngineSwapChain(
    MyEngineDevice &deviceRef, VkExtent2D extent,
    std::shared_ptr<MyEngineSwapChain> pervious)
    : device{deviceRef}, windowExtent{extent}, perviousSwapChain(pervious) {
  init();

  perviousSwapChain = nullptr;
}
...
void MyEngineSwapChain::createSwapChain() {
  ...
  createInfo.oldSwapchain =
      ((perviousSwapChain == nullptr) ? VK_NULL_HANDLE
                                      : perviousSwapChain->swapChain);
