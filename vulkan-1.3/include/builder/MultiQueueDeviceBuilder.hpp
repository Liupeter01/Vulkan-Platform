...
namespace engine {
          ...
          struct MultiQueueDeviceBuilder {
                    ...
                    struct QueueBlock {
                              ...
                              uint32_t startPos{};      //  position index in current queue family, usually be zero!
                              uint32_t count{};         // 
                    ...
                    struct QueueRequest {
                              QueueRequest(VkQueueFlagBits type = {})
                                        : queueType(type) {
                              }
                    ...
                    MultiQueueDeviceBuilder(vkb::DeviceBuilder& builder, vkb::PhysicalDevice& pdev);
                    MultiQueueDeviceBuilder& graphics(uint32_t count, bool presentQueueSupport = true, bool reserveImgui = true);
