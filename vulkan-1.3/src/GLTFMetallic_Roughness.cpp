...
namespace engine {
          ...
          namespace material {
                    GLTFMetallic_Roughness::GLTFMetallic_Roughness(VkDevice device) 
                              :device_(device)
                              , opaquePipeline{ device }
                              , transparentPipeline{device}
                              , writer_(device)
                    {}
                    ...
                    void GLTFMetallic_Roughness::init(VkDescriptorSetLayout globalSceneLayout) {
                              ...
                              materialLayout_ = DescriptorLayoutBuilder(device_)
                              ...
                              std::vector<VkDescriptorSetLayout> layouts{ globalSceneLayout, materialLayout_ };
                    ...
                    MaterialInstance GLTFMetallic_Roughness::generate_instance(MaterialPass pass,
                              ...
                              writer_.clear();
                              writer_.write_buffer(0, resources.materialConstantsData,
                                        sizeof(MaterialConstants), resources.materialConstantsOffset, 
