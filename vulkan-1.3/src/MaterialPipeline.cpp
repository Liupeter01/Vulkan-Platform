...
namespace engine {
          ...
          void  MaterialPipeline::create(MaterialPass pass,
                    ...
                    builder.set_shaders(CONFIG_HOME "shaders/pbr.vert.spv", CONFIG_HOME "shaders/pbr.frag.spv")
          ...
          void  MaterialPipeline::create_opaque_pipeline(GraphicPipelineBuilder& builder) {
                    pipeline_ = builder.disable_blending()
                              .build();
          }

          void  MaterialPipeline::create_transparent_pipeline(GraphicPipelineBuilder& builder) {
                    pipeline_ = builder.set_blending_alphablend(true)
                              .build();
          }
}