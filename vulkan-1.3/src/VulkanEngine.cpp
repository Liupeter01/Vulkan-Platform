...
namespace engine {
          ...
          void VulkanEngine::draw()
          {
                    ...
                    VkSemaphoreSubmitInfo swapChainImageWait =
                              tools::semaphore_submit_info(VK_PIPELINE_STAGE_2_COLOR_ATTACHMENT_OUTPUT_BIT_KHR, 
                    ...
                    vkQueueSubmit2(graphicsQueue_, 1, &info, get_current_frame()._renderFinishedFence);
          ...
          void VulkanEngine::init_vulkan() {
                    ...
                    vkb::PhysicalDevice _physicalDevice = selector
          ...
          {
                    create_swapchain(window_.getExtent().width,
          ...
          void VulkanEngine::init_commands()
          {
                    VkCommandPoolCreateInfo commandPoolInfo = 
                              tools::command_pool_create_info(graphicsQueueFamily_, VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT);

                    for (auto& frame : frames_) {
                              vkCreateCommandPool(device_, &commandPoolInfo, nullptr, &frame._commandPool);
          ...
          void VulkanEngine::init_sync()
          {
                    ...
                    VkSemaphoreCreateInfo semaphoreCreateInfo = 
                              tools::semaphore_create_info();

                    for (auto& frame : frames_) {
                              vkCreateFence(device_, &fenceCreateInfo, nullptr, &frame._renderFinishedFence);
                              vkCreateSemaphore(device_, &semaphoreCreateInfo, nullptr, &frame._swapChainWait);
                              vkCreateSemaphore(device_, &semaphoreCreateInfo, nullptr, &frame._renderPresentKHRSignal);
                    }
          }
