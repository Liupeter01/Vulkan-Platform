...
namespace engine {
          ...
          NodeManagerBuilder::NodeManagerBuilder(VulkanEngine* eng)
                    :engine_(eng)
          {}
          ...
          NodeManagerBuilder& NodeManagerBuilder::set_filepath(std::filesystem::path filePath) {
                    filepath_ = filePath;
                    return *this;
          }
          ...
          std::optional<std::shared_ptr<NodeManager>> NodeManagerBuilder::build() {
                    ...
                    if (root_name.empty()) {
                              spdlog::critical(
                                        "[NodeManagerBuilder Critical]: Invalid Root Name!");
                              return {};
                    }
