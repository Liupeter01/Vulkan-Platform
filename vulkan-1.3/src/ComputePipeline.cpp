...
namespace engine {
          namespace compute {
                    ...
                    ComputePipelinePacked::ComputePipelinePacked(VkDevice device)
                              :device_(device), isInit_(false), descriptorAllocator_{device, 10, sizes},builder{ device }
                    { }

                    ComputePipelinePacked::~ComputePipelinePacked() {
                              destroy();
                    }
                    ...
                    void ComputePipelinePacked::draw_compute(VkCommandBuffer& cmd, VkExtent2D drawExtent) {
                              ...
                              vkCmdDispatch(
                                        cmd, static_cast<uint32_t>(std::ceil(drawExtent.width / 16.0f)),
