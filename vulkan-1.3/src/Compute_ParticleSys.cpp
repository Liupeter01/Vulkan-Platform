...
namespace engine {
          ...
          ParticleSysDataBuffer::~ParticleSysDataBuffer() {
                    destroy();
          }
          ...
          void ParticleSysDataBuffer::fill(void* buffer, const std::size_t particle_count) {
                    ...
                    for (std::size_t i = 0; i < particle_count; ++i) {
                             ...
                             const float x = r * cosf(theta) * engine_->drawExtent_.height / engine_->drawExtent_.width;
