...
namespace engine {
          namespace mesh {
                    ...
                    MeshAsset::loadGltfMeshes(VkDevice device, VmaAllocator allocator, std::filesystem::path filePath) {
                              ...
                              auto load_gltf = parser.loadGltfBinary(gltfData.get(), filePath.parent_path(), gltfOptions);
                              if (!load_gltf) {
                                        std::cerr << "Failed to load GLB file: " <<  fastgltf::to_underlying(load_gltf.error()) << "\n";
                                        return std::nullopt;
                              }
